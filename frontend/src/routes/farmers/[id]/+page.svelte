    ...
    onMount(() => {
        ...
        if (farmerId === "1") {
            farmer = {
                ...
                description: "自然と共に生きる農業を目指しています。無農薬・有機栽培にこだわり、安全でおいしい野菜を育てています。当園では、季節ごとの旬の野菜を大切に育て、収穫から出荷まで一貫して行っています。土づくりから始まり、自然の恵みを活かした農法で、安全で栄養価の高い野菜作りに取り組んでいます。",
                location: "長野県松本市",
            ...
            products = [
                {
                    ...
                    description: "甘みが強く、生でも美味しく食べられる有機栽培のにんじんです。",
                    harvestSeason: "春・秋",
                    price: "300円/束",
            ...
            farmer = {
                ...
                description: "代々続く農家の伝統を守りながらも、新しい技術を取り入れた農業を実践しています。山に囲まれた自然豊かな場所で、四季折々の果物を栽培しています。先代から受け継いだ技術と、最新の栽培方法を融合させた独自の栽培方法で、味と品質にこだわった果物を育てています。",
                location: "山梨県笛吹市",
            ...
            products = [
                ...
                },
                {
                    ...
                    description: "とろけるような食感と甘い香りが楽しめる、山梨県自慢の白桃です。",
                    harvestSeason: "夏",
                    price: "800円/個",
            ...
            farmer = {
                ...
                description: "自然豊かな山間部で育てる作物は、味と栄養にこだわっています。四季折々の野菜と果物を提供します。標高の高い場所で育つため、昼夜の寒暖差を活かした栽培方法で、野菜本来の味を引き出しています。農薬使用を最小限に抑え、環境に配慮した持続可能な農業を実践しています。",
                location: "茨城県つくば市",
...
<svelte:head>
    ...
    <meta name="description" content="{farmer.name}のプロフィールページ。農作物情報やこだわりを紹介しています。" />
</svelte:head>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden mb-8">
        <div class="p-6">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-3/4">
                    <h1 class="text-3xl font-bold mb-4">{farmer.name}</h1>
                    <div class="mb-4">
                        ...
                        {#if farmer.certifications && farmer.certifications.length > 0}
                            <div class="mb-4">
                                <h3 class="text-lg font-medium mb-2">認証・取得資格</h3>
                                <div class="flex flex-wrap gap-2">
                                    {#each farmer.certifications as cert}
                                        <span class="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-100 rounded-full text-sm">{cert}</span>
                                    {/each}
                                </div>
                            </div>
                        {/if}
    ...
    <!-- 農作物一覧セクション -->
    <h2 class="text-2xl font-bold mb-6">栽培している農作物</h2>
        ...
        {#each products as product}
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105">
                <div class="aspect-w-16 aspect-h-9 overflow-hidden">
                    <img src={product.image} alt="{product.name}の写真" class="w-full h-full object-cover" on:error={handleProductImageError} />
                </div>
                <div class="p-6">
                    ...
                    <a href="/farmers/{farmer.id}/products/{product.id}" class="inline-block mt-2 text-blue-600 dark:text-blue-400 hover:underline">
                        詳細・レビューを見る →
                    </a>
                </div>
            </div>
